...
public class AlgorithmId implements Serializable, DerEncoder {
    ...
    protected void decodeParams() throws IOException {
        ...
        if (algidName.equals("DSA") || algidName.equals("Diffie-Hellman")) {
            // 3rd party interop issue for DSA/DH in JSafeJCE.
            // Restore pre JDK-8242556 behaviour for DSA/DH
            // until fix is available from JSafeJCE.
            // JSafeJCE reference:
            // BSFCRYJ-4956 - Update to the DH and DSA parameter
            // decoding to support no algorithm OID
            algidName = algid.toString();
        }
        try {
